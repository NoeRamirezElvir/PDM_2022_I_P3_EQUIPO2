...
import hn.edu.ujcv.pdm_2022_i_p3_equipo3.clases.Empleado
import kotlinx.android.synthetic.main.card_layout_empleado.view.*

class RecyclerAdapterEmpleado(pLista:ArrayList<Empleado>? = null) : RecyclerView.Adapter<RecyclerAdapterEmpleado.ViewHolder>(){
    var listaEmpleado:ArrayList<Empleado>? = pLista
